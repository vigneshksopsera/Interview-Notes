...
public class DijkstraAdjacencyMatrix {
    ...
    static class Graph{
        ...
        int getMinimumVertex(boolean [] mst, int [] key){ // 0,1,2
        ...
        public void dijkstra_GetMinDistances(int sourceVertex){
            boolean[] spt = new boolean[vertices]; //0
            ...
            for (int i = 0; i <vertices ; i++) {
                ...
                System.out.println("Source idx U: " + vertex_U);
                    ...
                    if(matrix[vertex_U][vertex_V]>0){
                        ...
                        if(spt[vertex_V]==false && matrix[vertex_U][vertex_V]!=INFINITY){
                            ...
                            if(newKey<distance[vertex_V])
                            	...
                            	System.out.println("Adjacent idx V: " + vertex_V + " and distance: "+ distance[vertex_V]);
                        }
                    }
                }
            }
